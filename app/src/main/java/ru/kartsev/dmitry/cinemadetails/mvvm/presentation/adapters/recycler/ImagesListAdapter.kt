...
import ru.kartsev.dmitry.cinemadetails.mvvm.presentation.adapters.helper.DefaultDiffCallback
...
class ImagesListAdapter(
    ...
    class ItemMovieImageViewHolder(
        ...
        fun cleanupImagesTask() {
            get<Picasso>(named(PICASSO_NAME)).cancelRequest(binding.itemMovieImagePoster)
        }
    }
}